...
export default function InfoCard(props) {
  return (
    <div>
      <div
        className={`card info-card ${(props.cardData.border !== "" ? `border-${props.cardData.border}` : "")}`}
        style={{ border: "0" }}
      >
        <div className={`${props.cardBreakpointClass === "center" ? "text-center" : ""} card-body`}>
          ...
          <div
            className={`card-percentage d-flex align-items-center ${props.cardBreakpointClass === "center" ? "justify-content-center" : ""}`}
            style={{
              color: `${
